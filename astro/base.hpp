...
namespace astro{
    ...
    template<numm::number_type num_t>
    using longitude_ascending_node_t = phys_val<num_t, phys_val_tag::longitude_ascending_node>;

    template<numm::number_type num_t>
    using argument_periapsis_t = phys_val<num_t, phys_val_tag::argument_periapsis>;*/
